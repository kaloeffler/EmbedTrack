...
To make our code more accessible, we added a **[Google Colab Notebook](https://git.scc.kit.edu/kit-loe-ge/embedtrack/-/blob/master/kit_loe_ge.ipynb)** for simple training and inference on data sets from the Cell Tracking Challenge. The Colab notebook includes all steps: setting up the environment, retrieving the CTC data sets, training data creation, training, and inference -- using your own trained models or using our models submitted for the Cell Tracking Challenge.
